...
export const INITIAL_TYPES: ProductTypeDefinition[] = [
  { id: 't1', name: '销售套餐', level: 1, color: 'purple' },
  { id: 't2', name: '成品', level: 2, color: 'blue' },
  { id: 't3', name: '组件', level: 3, color: 'amber' },
  { id: 't4', name: '零件', level: 4, color: 'slate' }
];
...
export const INITIAL_BOMS: BOMStructure[] = [
  {
    ...
    items: [
      { id: 'b1', productId: 'p1', quantity: 1 }, // Base Server
      { id: 'b2', productId: 'p2', quantity: 2 }, // Extra CPUs
    ]
  },
  {
    id: 'bom2',
    rootProductId: 'p0', // Tied to Solution
    name: '数据中心促销包',
    items: [
      { id: 'b_sol_1', productId: 'p1', quantity: 3 } // Contains 3 Finished Goods
    ]
  }
];
...
export const INITIAL_QUOTES: Quote[] = [
  {
    ...
    items: [
      ...
      { id: 'qi1', productId: 'p1', quantity: 5, unitPrice: 16000, margin: 0, total: 80000 }
    ],
    subtotal: 80000,
    tax: 7200, // 9%
    grandTotal: 87200
  },
  {
    ...
    status: 'Sent',
    items: [
      { id: 'qi2', productId: 'p0', quantity: 1, unitPrice: 50000, margin: 0, total: 50000 }
    ],
    subtotal: 50000,
    tax: 4500, // 9%
    grandTotal: 54500
  },
  {
    ...
    items: [
      ...
      { id: 'qi3', productId: 'p1', quantity: 2, unitPrice: 16000, margin: 0, total: 32000 }
    ],
    subtotal: 32000,
    tax: 2880, // 9%
    grandTotal: 34880
