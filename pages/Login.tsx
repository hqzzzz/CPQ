...
import { Lock, User, CheckCircle, AlertCircle, Github, Mail, Command, ChevronDown, ChevronUp } from 'lucide-react';
...
const Login = () => {
  ...
  const demoUsers = [
      { id: 'admin', label: '管理员', color: 'bg-slate-800', pass: 'admin' },
      { id: 'design', label: '设计师', color: 'bg-violet-600', pass: '123' },
      { id: 'sales', label: '销售人员', color: 'bg-blue-600', pass: '123' },
  ];
